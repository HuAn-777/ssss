...
public class CourseOff {
    ...
    public CourseOff(String id, String name, String users, String mt, String st, String grade, String studymodel, Date timestamp, String charge, String valid, String qq, Float price, Float priceOld, Date expires, String pic) {
        this.id = id;
        this.name = name;
        this.users = users;
        this.mt = mt;
